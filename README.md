...
heroku config:set IBM_API_KEY=xxx IBM_PROJECT_ID=xxx IBM_REGION_URL=xxx IBM_MODEL_ID=xxx FLASK_SECRET_KEY=xxx
...
docker run -p 5000:5000 --env-file .env startup-blueprint-ai
```
...
Built as part of the **IBM AICTE EduNet Programme** using IBM watsonx.ai and IBM Granite foundation models.
